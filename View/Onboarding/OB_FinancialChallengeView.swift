//
//  OB_FinancialChallengeView.swift
//  Flamora app
//
...
struct OB_FinancialChallengeView: View {
                ...
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    VStack(spacing: 10) {
                        ForEach(challengeOptions) { option in
                            ChallengeCard(
                                option: option,
                                isSelected: data.primaryChallenge == option.key,
                                onTap: {
                                    withAnimation(.easeInOut(duration: 0.18)) {
                                        if data.primaryChallenge == option.key {
                                            data.primaryChallenge = ""
                                        } else {
                                            data.primaryChallenge = option.key
                                        }
                                    }
                                }
                            )
...
#Preview {
    ZStack {
        ...
        OB_FinancialChallengeView(data: OnboardingData(), onNext: {})
    }
}
