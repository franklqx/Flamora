        ...
        ZStack(alignment: .bottom) {
            ...
            VStack(spacing: 0) {
                ...
                Text(slides[currentSlide].title)
                    ...
                    .padding(.top, 26)
                    // Fixed height prevents card from jumping when line count differs
            ...
            // Exclude CTA + dots zone from tap overlay
...
struct ProceduralSkyView: View {
    var body: some View {
        ZStack {
            // Base gradient — vivid cornflower blue tapering to pale haze
            LinearGradient(
                colors: [
                    Color(red: 0.26, green: 0.48, blue: 0.76),   // deep sky top
                    Color(red: 0.34, green: 0.57, blue: 0.82),   // upper-mid
                    Color(red: 0.46, green: 0.68, blue: 0.88),   // mid blue
                    Color(red: 0.63, green: 0.80, blue: 0.93),   // lower blue
                    Color(red: 0.82, green: 0.92, blue: 0.97),   // near-white haze
                ],
                startPoint: .top,
                endPoint: .bottom
            )

            // Large soft cloud — upper right
            Ellipse()
            ...
            // Wide cloud bank — lower center (visible below card)
            Ellipse()
...
private struct WelcomeFireProgressCard: View {
    ...
    var body: some View {
        GlassCard {
            // Explicit spacing: header → small gap → subtitle → large gap → circle
            VStack(alignment: .leading, spacing: 0) {
                ...
                // Subtitle — lighter weight, natural line wrap, anchored to top
                ...
                // Larger gap pushes circle into lower half of card
