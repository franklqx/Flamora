...
//  Flamora app
//
//  V2 Onboarding - Step 9: Age & Currency (Snapshot 1/5)
//

import SwiftUI

struct OBV2_AgeView: View {
    ...
    var body: some View {
        ZStack {
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                OBV2_SnapshotProgress(current: 1)
...
private struct OBV2_CurrencyPickerSheet: View {
