//
//  OBV2_MotivationView.swift
//  Flamora app
//
//  V2 Onboarding - Step 5: Motivation Multi-Select
//

import SwiftUI

struct OBV2_MotivationView: View {
    ...
    var body: some View {
        ZStack {
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                OBV2_PersonalizeProgress(currentStep: 3, totalSteps: 5)
