//
//  OBV2_ValueScreenView.swift
//  Flamora app
//
//  V2 Onboarding - Step 8: Dynamic Value Screen (based on painPoint)
//

import SwiftUI

struct OBV2_ValueScreenView: View {
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                OBV2_PersonalizeProgress(currentStep: 5, totalSteps: 5)
